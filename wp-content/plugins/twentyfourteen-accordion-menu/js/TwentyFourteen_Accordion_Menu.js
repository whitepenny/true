function TwentyFourteen_Accordion_Menu(){
	...
	jQuery('#site-navigation ul#primary-menu ul.sub-menu').show();
	...
	jQuery('#site-navigation ul#primary-menu ul.sub-menu').hide();
    ...
    jQuery('#site-navigation ul#primary-menu > li > a').click(function(e){
	...
	jQuery('#site-navigation ul#primary-menu > li > ul.sub-menu').not(current_submenu).slideUp(function(){

	    
	    // remove sub-menu-active class from all first level items except current parent li

	    jQuery('#site-navigation ul#primary-menu > li').not(parent_li).removeClass('sub-menu-active');
    ...
    jQuery('#site-navigation ul#primary-menu ul.sub-menu > li > a').click(function(e){
	...
	jQuery('#site-navigation ul#primary-menu ul.sub-menu > li > ul.sub-menu').not(current_submenu).slideUp(function(){

	    
	    // remove sub-menu-active class from all second level items except current parent li

	    jQuery('#site-navigation ul#primary-menu ul.sub-menu > li').not(parent_li).removeClass('sub-menu-active');
